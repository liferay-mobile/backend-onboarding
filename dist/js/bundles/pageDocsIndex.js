...
goog.loadModule(function (exports) {
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    $templateAlias2({ section: opt_data.site.index.children['documentation'], site: opt_data.site }, null, opt_ijData);
  ...
  function $topics(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'row');
    var childIdList390 = opt_data.page.childIds;
    var childIdListLen390 = childIdList390.length;
    for (var childIdIndex390 = 0; childIdIndex390 < childIdListLen390; childIdIndex390++) {
      var childIdData390 = childIdList390[childIdIndex390];
      var topic__soy380 = opt_data.page.children[childIdData390];
      if (!topic__soy380.hidden) {
        ie_open('div', null, null, 'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
        ie_open('a', null, null, 'class', 'topic radial-out', 'href', topic__soy380.url);
        ie_open('div', null, null, 'class', 'topic-icon');
        ie_void('span', null, null, 'class', 'icon-16-' + topic__soy380.icon);
        ie_close('div');
        ie_open('h3', null, null, 'class', 'topic-title');
        var dyn29 = topic__soy380.title;
