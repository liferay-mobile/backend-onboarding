...
var bvfQo = function (_Component) {
  _inherits(bvfQo, _Component);

  function bvfQo() {
    _classCallCheck(this, bvfQo);

    return _possibleConstructorReturn(this, (bvfQo.__proto__ || Object.getPrototypeOf(bvfQo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bvfQo, _indexSoy2.default);

exports.default = bvfQo;
...
exports.templates = exports.bvfQo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bvfQo.
   * @public
   */

  goog.module('bvfQo.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param522 = function param522() {
      ...
      ie_close('h2');
      ie_open('p');
      itext('This library was developed in Kotlin, it is just a SDK to make a backpressure of Analytics events to send to Analytics Cloud. Actually we support only custom events and some forms events. More informations can be found in our repository.');
      ie_close('p');
      ie_open('h2');
      itext('Repository');
      ie_close('h2');
      ie_open('p');
      ie_open('a', null, null, 'href', 'https://github.com/liferay-mobile/liferay-analytics-android');
      itext('https://github.com/liferay-mobile/liferay-analytics-android');
      ie_close('a');
      ie_close('p');
      ie_close('article');
      ...
      ie_close('p');
      ie_open('p');
      itext('You need to request an account an invite to have access on Codacy');
      ie_close('p');
      ie_close('article');
      ...
      ie_open('code');
      itext('/analytics-core/build.gradle');
      ie_close('code');
      itext(' file, in ');
      ie_open('code');
      ...
      itext('You need to increase the version, found in ');
      ie_open('code');
      itext('/analytics-forms/build.gradle');
      ie_close('code');
      itext(' file, in ');
      ie_open('code');
      itext('android/defaultConfig/versionName');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bvfQo.render';
  }
...
_metalSoy2.default.register(bvfQo, templates);
exports.bvfQo = bvfQo;
