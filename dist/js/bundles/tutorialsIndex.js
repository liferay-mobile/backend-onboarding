...
goog.loadModule(function (exports) {
  ...
  function $topics(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Tutorials and Tips');
    ie_close('h1');
    ie_open('p', null, null, 'class', 'docs-home-top-description');
    itext('Little help when you need!');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_open('div', null, null, 'class', 'row');
    ...
    for (var childIdIndex438 = 0; childIdIndex438 < childIdListLen438; childIdIndex438++) {
      ...
      var topic__soy428 = opt_data.page.children[childIdData438];
      if (!topic__soy428.hidden) {
        ie_open('div', null, null, 'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
        ie_open('a', null, null, 'class', 'topic radial-out', 'href', topic__soy428.url);
        ie_open('div', null, null, 'class', 'topic-icon');
        ie_void('span', null, null, 'class', 'icon-16-' + topic__soy428.icon);
        ie_close('div');
        ie_open('h3', null, null, 'class', 'topic-title');
        var dyn30 = topic__soy428.title;
  ...
  if (goog.DEBUG) {
    $topics.soyTemplateName = 'tutorialsIndex.topics';
  }
