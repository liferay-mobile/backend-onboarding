...
var pageTeamSearch = function (_Component) {
  _inherits(pageTeamSearch, _Component);

  function pageTeamSearch() {
    _classCallCheck(this, pageTeamSearch);

    return _possibleConstructorReturn(this, (pageTeamSearch.__proto__ || Object.getPrototypeOf(pageTeamSearch)).apply(this, arguments));
  }

  return pageTeamSearch;
}(_metalComponent2.default);

;

_metalSoy2.default.register(pageTeamSearch, _searchSoy2.default);

exports.default = pageTeamSearch;
...
exports.templates = exports.pageTeamSearch = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pageTeamSearch.
   * @public
   */

  goog.module('pageTeamSearch.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param346 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pageTeamSearch.render';
  }
...
_metalSoy2.default.register(pageTeamSearch, templates);
exports.pageTeamSearch = pageTeamSearch;
