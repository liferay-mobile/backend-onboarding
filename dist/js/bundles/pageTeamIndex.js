...
_metalSoy2.default.register(pageTeamIndex, _indexSoy2.default);
...
exports.templates = exports.pageTeamIndex = undefined;
...
goog.loadModule(function (exports) {
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    $templateAlias2({ section: opt_data.site.index.children['team'], site: opt_data.site }, null, opt_ijData);
  ...
  function $topics(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Stay informed about what is happening in the team.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_open('div', null, null, 'class', 'row');
    ...
    itext('Choose a Topic');
    ie_close('h2');
    ie_open('p', null, null, 'class', 'docs-home-middle-description');
    itext('Each one provides a description of how it is our daily work.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
    ...
    ie_open('div', null, null, 'class', 'row');
    var childIdList340 = opt_data.page.childIds;
    var childIdListLen340 = childIdList340.length;
    for (var childIdIndex340 = 0; childIdIndex340 < childIdListLen340; childIdIndex340++) {
      var childIdData340 = childIdList340[childIdIndex340];
      var topic__soy330 = opt_data.page.children[childIdData340];
      if (!topic__soy330.hidden) {
        ie_open('div', null, null, 'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
        ie_open('a', null, null, 'class', 'topic radial-out', 'href', topic__soy330.url);
        ie_open('div', null, null, 'class', 'topic-icon');
        ie_void('span', null, null, 'class', 'icon-16-' + topic__soy330.icon);
        ie_close('div');
        ie_open('h3', null, null, 'class', 'topic-title');
        var dyn27 = topic__soy330.title;
  ...
  if (goog.DEBUG) {
    $topics.soyTemplateName = 'pageTeamIndex.topics';
  }
...
_metalSoy2.default.register(pageTeamIndex, templates);
exports.pageTeamIndex = pageTeamIndex;
